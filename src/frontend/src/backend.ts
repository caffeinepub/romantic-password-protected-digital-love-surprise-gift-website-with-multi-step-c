...
export class Backend implements backendInterface {
    ...
    async deleteGiftPage(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteGiftPage(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getGiftPage(arg0: string): Promise<GiftPage> {
        if (this.processError) {
            try {
                const result = await this.actor.getGiftPage(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getGiftPageIdsAndTitlesByOwner(arg0: Principal): Promise<Array<[string, string]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getGiftPageIdsAndTitlesByOwner(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getGiftPageTitleAndId(arg0: string): Promise<[string, string]> {
        if (this.processError) {
            try {
                const result = await this.actor.getGiftPageTitleAndId(arg0);
                return [
                    result[0],
                    result[1]
                ];
    ...
    async getGiftPages(): Promise<Array<GiftPage>> {
        if (this.processError) {
            try {
                const result = await this.actor.getGiftPages();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getGiftPagesByOwner(arg0: Principal): Promise<Array<GiftPage>> {
        if (this.processError) {
            try {
                const result = await this.actor.getGiftPagesByOwner(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveGiftPage(arg0: string, arg1: string, arg2: Uint8Array, arg3: string, arg4: Array<[bigint, bigint, Uint8Array]>): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.saveGiftPage(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
